...
class TabulateTests(TestCase):
    ...
    def test_simple_tabulate(self) -> None:
        """Test the happy path"""
...
class NcyclesTests(TestCase):
    ...
    def test_pathalogical_case(self) -> None:
...
class GrouperTests(TestCase):
    ...
    def test_legacy_order(self) -> None:
...
class RoundrobinTests(TestCase):
    ...
    def test_even_groups(self) -> None:
...
class IterExceptTests(TestCase):
    ...
    def test_uncaught_exception_is_raised(self) -> None:
...
class FirstTrueTests(TestCase):
    ...
    def test_something_true(self) -> None:
        """Test with no keywords"""
        self.assertEqual(mi.first_true(range(10)), 1)

    def test_nothing_true(self) -> None:
    ...
    def test_pred(self) -> None:
        ...
        pred = lambda x: x % 3 == 0
        self.assertEqual(mi.first_true([2, 4, 6], pred=pred), 6)
...
class RandomProductTests(TestCase):
    ...
    def test_simple_lists(self) -> None:
        ...
        n_set, m_set = set(n), set(m)
        self.assertEqual(n_set, set(nums))
        self.assertEqual(m_set, set(lets))
        self.assertEqual(len(n_set), len(nums))
        self.assertEqual(len(m_set), len(lets))

    def test_list_with_repeat(self) -> None:
...
class RandomPermutationTests(TestCase):
    ...
    def test_full_permutation(self) -> None:
    ...
    def test_partial_permutation(self) -> None:
...
class RandomCombinationTests(TestCase):
    ...
    def test_pseudorandomness(self) -> None:
