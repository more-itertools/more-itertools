...
from typing_extensions import Protocol, Never
...
@overload
def always_iterable(obj: None, base_type: Any) -> Iterator[Never]: ...
@overload
def always_iterable(obj: str, base_type=(str, bytes)) -> Iterator[str]: ...
@overload
def always_iterable(obj: bytes, base_type=(str, bytes)) -> Iterator[bytes]: ...
@overload  # The happy path
def always_iterable(obj: Iterable[_T], base_type: None) -> Iterator[_T]: ...
@overload  # If iter(obj) raises a type error
def always_iterable(obj: _T1, base_type: None) -> Iterator[_T1]: ...
@overload  # Handle the exclusion mechanism
def always_iterable(obj: _T2, base_type: type[_T2]) -> Iterator[_T2]: ...
@overload
def always_iterable(
    obj: Iterable[_T3], base_type: _ClassInfo
) -> Iterator[_T3]: ...
@overload
def always_iterable(obj: _T4, base_type: _ClassInfo) -> Iterator[_T4]: ...
def adjacent(
