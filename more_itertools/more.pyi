...
from typing import (Callable, Generic, Iterable, Iterator, List, Mapping,
...
def first(iterable: Any, default: Any = ...): ...
...
def map_reduce(iterable: Any, keyfunc: Any, valuefunc: Optional[Any] = ..., reducefunc: Optional[Any] = ...): ...
